# Factory Simulation Coding Challenge
...
Please use the following link to access the website - open the console to see the final result: https://e-davies.github.io/factory-simulation/
